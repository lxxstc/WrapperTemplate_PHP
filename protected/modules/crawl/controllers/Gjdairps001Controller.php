...
class Gjdairps001Controller extends Controller
{
     ...
     */
    private function getFlightInfo($type = 0)
    {
    ...
    {
        $booking = $this->urlBooking(2);
        exit(CJSON::encode($booking));
    }

    /**
     * booking url 
     * @param integer $type 1单程 2往返
     * @return string $booking
     */
    private function urlBooking($type)
    {
        //url 
        if ($type == 1)
        {
