...
/**
 * This is the model class for table "airportcode".
 *
 * The followings are the available columns in table 'airportcode':
 ...
 */
class Airportcode extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Airportcode the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('belongToCity, Code, airport_zh, airport_en, airport_zh_short', 'required'),
			...
			array('belongToCity, Code, airport_zh, airport_en, validate, airport_zh_short', 'safe', 'on'=>'search'),
		);
	}
