...
class Airline extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('code, icon, name_zh, name_en, name_zh_short, name_zh_short_2code', 'required'),
			...
			array('id, code, icon, name_zh, name_en, name_zh_short, name_zh_short_2code, telephone', 'safe', 'on'=>'search'),
		);
	}
