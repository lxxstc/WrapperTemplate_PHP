...
/**
 * This is the model class for table "countrys_publish".
 *
 * The followings are the available columns in table 'countrys_publish':
 * @property string $uri
 ...
 */
class CountrysPublish extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CountrysPublish the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('uri, countryname_zh, countryname_en, shortcode, code, publish_time, country3code', 'required'),
			...
			array('uri, countryname_zh, countryname_en, validate, belongToContinent, shortcode, code, publish_time, country2code, country3code', 'safe', 'on'=>'search'),
		);
	}
